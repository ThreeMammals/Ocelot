...
namespace Ocelot.Provider.Consul
{
    ...
    public sealed class PollConsul : IServiceDiscoveryProvider, IDisposable
    {
        ...
        public PollConsul(int pollingInterval, string serviceName, IOcelotLoggerFactory factory, IServiceDiscoveryProvider consulServiceDiscoveryProvider, IMemoryCache cache)
        {
