...
release = 'v23.0 "Sunny Koliada"' # OK displayed
version = '23.0' # version is not displayed in either HTML pages or PDF docs
today = 'February 13, 2024'
