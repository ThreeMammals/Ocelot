...
-->
## Upgrade to [.NET 10](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) SDK (TFM `net10.0`, version 25.0) a.k.a. the [.NET 10](https://devblogs.microsoft.com/dotnet/announcing-dotnet-10/) release
...
- :star: **[Quality of Service](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/qualityofservice.rst)**: A "[Built-in Circuit Breaker](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/qualityofservice.rst#built-in-qos)" feature [implementation](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/qualityofservice.rst#implementations-overview) was added by @ocelot-ot in pull request #2385 — no [Polly](https://www.nuget.org/packages/Polly/) required. :star:
  ...
  The [two implementations](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/qualityofservice.rst#implementations-overview) are mutually exclusive: the last of `AddQualityOfService()` or `AddPolly()` registered on the `OcelotBuilder` wins.
  See the [built-in QoS](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/qualityofservice.rst#built-in-qos) documentation for full details, including the `AddQualityOfService<THandler>()` extensibility point for overriding server error codes.

- **[WebSockets](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/websockets.rst)**: The "[Overridable WebSocket buffer size](https://github.com/ThreeMammals/Ocelot/issues/2386)" feature and custom middleware injection were added by @erannevo in pull request #2387.
  ...
  The [Middleware Injection](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/middlewareinjection.rst) feature was extended with a `WebSocketsProxyMiddleware` override on the [OcelotPipelineConfiguration class](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/middlewareinjection.rst#ocelotpipelineconfiguration-class), allowing a fully custom WebSocket middleware to be injected into the pipeline.
  Refer to the "[Sample](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/websockets.rst#sample-6)" section to understand how to utilize the new feature.

- **[WebSockets](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/websockets.rst)**: The "[SecurityOptions support for the WebSocket pipeline](https://github.com/ThreeMammals/Ocelot/issues/2403)" feature was added by @CurtisRobertOliver in pull request #2406.
...
- **[Extension packages](https://www.nuget.org/profiles/ThreeMammals)** extraction #2334: The Ocelot team continued extracting [integrated extension packages](https://www.nuget.org/profiles/ThreeMammals) out of [the monorepo](https://github.com/ThreeMammals/Ocelot/tree/24.1.0/src) into their own [dedicated repositories](https://github.com/orgs/ThreeMammals/repositories?q=Ocelot.), each with an independent release cycle:
  ...
  * [Ocelot.Discovery.KubeClient](https://github.com/ThreeMammals/Ocelot.Discovery.KubeClient/) (renamed from `Ocelot.Provider.Kubernetes`, see issue #2378) in pull request #2404
  ...
  Consult the [Caching](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/caching.rst), [Tracing](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/tracing.rst), [Service Discovery](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/servicediscovery.rst), and [Kubernetes](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/kubernetes.rst) chapters for package-specific upgrade notes.
  Please note that some of the packages are deprecated! To watch the status of each package and its repository, go to the [Release Radar](https://github.com/ThreeMammals/Ocelot/blob/develop/ReleaseRadar.md) status page.
...
- **[Routing](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/routing.rst)**: Issue #2346 was patched by @bhargav-polara in pull request #2351.
...
- **[Error Handling](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/errorcodes.rst)**: Issue #2376 was patched by @Majdi-Zlitni in pull request #2379.
...
- :fire: **[WebSockets](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/websockets.rst)**: Critical issue #2403 was patched by @CurtisRobertOliver in pull request #2406. :fire:
...
- **[Aggregation](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/aggregation.rst)**: Issue #2248 was patched by @NandanDevHub in pull request #2328.
  ...
  [Complex Aggregation](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/aggregation.rst#complex-aggregation) routes configured with the `RouteKeysConfig` array now correctly map route keys to the corresponding aggregator context, fixing a bug where keys could be mismatched or dropped during multiplexing.

- **[Administration](https://github.com/ThreeMammals/Ocelot/blob/develop/docs/features/administration.rst)**: Issue #989 was patched by @mmustafasenoglu in pull request #2412.
