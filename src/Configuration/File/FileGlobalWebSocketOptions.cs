...
public class FileGlobalWebSocketOptions : FileWebSocketOptions, IRouteGroup
{
    public FileGlobalWebSocketOptions() : base() { }
    public FileGlobalWebSocketOptions(FileWebSocketOptions from) : base(from) { }
    public FileGlobalWebSocketOptions(WebSocketOptions from) : base(from) { }
