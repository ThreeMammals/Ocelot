...
namespace Ocelot.UnitTests.Configuration
{
    public class HttpHandlerOptionsCreatorTests
    {
        ...
        public void should_not_use_tracing_if_fake_tracer_registered()
        {
            ...
            var expectedOptions = new HttpHandlerOptions(false, false, false, true, int.MaxValue, TimeSpan.FromSeconds(HttpHandlerOptionsCreator.DefaultPooledConnectionLifetimeSeconds));
        ...
        public void should_use_tracing_if_real_tracer_registered()
        {
            ...
            var expectedOptions = new HttpHandlerOptions(false, false, true, true, int.MaxValue, TimeSpan.FromSeconds(HttpHandlerOptionsCreator.DefaultPooledConnectionLifetimeSeconds));
        ...
        public void should_create_options_with_specified_useproxy()
        {
            ...
            var expectedOptions = new HttpHandlerOptions(false, false, false, false, int.MaxValue, TimeSpan.FromSeconds(HttpHandlerOptionsCreator.DefaultPooledConnectionLifetimeSeconds));
        ...
        public void should_create_options_with_specified_MaxConnectionsPerServer()
        {
            ...
            var expectedOptions = new HttpHandlerOptions(false, false, false, true, 10, TimeSpan.FromSeconds(HttpHandlerOptionsCreator.DefaultPooledConnectionLifetimeSeconds));
