...
| Project | Release | Pre-Release | Release Date |
|---------|---------|-------------|--------------|
| [![Ocelot repository](https://img.shields.io/github/v/release/ThreeMammals/Ocelot?logo=github&label=Ocelot&include_prereleases)](https://github.com/ThreeMammals/Ocelot/ "Ocelot repository") | [![Ocelot package](https://img.shields.io/nuget/v/Ocelot?logo=nuget&label=Ocelot)](https://www.nuget.org/packages/Ocelot/ "Ocelot package") | [![Ocelot Beta](https://img.shields.io/nuget/vpre/Ocelot?logo=nuget&label=Ocelot)](https://www.nuget.org/packages/Ocelot/ "Ocelot beta package") | [![Ocelot Release Date](https://img.shields.io/github/release-date/ThreeMammals/Ocelot?label=Ocelot)](https://github.com/ThreeMammals/Ocelot/releases) |
| [![Ocelot.Discovery.Consul repository](https://img.shields.io/github/v/release/ThreeMammals/Ocelot.Discovery.Consul?logo=github&label=Ocelot.Discovery.Consul&include_prereleases)](https://github.com/ThreeMammals/Ocelot.Discovery.Consul/ "Ocelot.Discovery.Consul repository") | [![Ocelot.Discovery.Consul package](https://img.shields.io/nuget/v/Ocelot.Discovery.Consul?logo=nuget&label=Ocelot.Discovery.Consul)](https://www.nuget.org/packages/Ocelot.Discovery.Consul/ "Ocelot.Discovery.Consul package") | [![Ocelot.Discovery.Consul Beta](https://img.shields.io/nuget/vpre/Ocelot.Discovery.Consul?logo=nuget&label=Ocelot.Discovery.Consul)](https://www.nuget.org/packages/Ocelot.Discovery.Consul/ "Ocelot.Discovery.Consul beta package") | [![Ocelot.Discovery.Consul Release Date](https://img.shields.io/github/release-date/ThreeMammals/Ocelot.Discovery.Consul?label=Ocelot.Discovery.Consul)](https://github.com/ThreeMammals/Ocelot.Discovery.Consul/releases) |
| [![Ocelot.Discovery.Eureka repository](https://img.shields.io/github/v/release/ThreeMammals/Ocelot.Discovery.Eureka?logo=github&label=Ocelot.Discovery.Eureka&include_prereleases)](https://github.com/ThreeMammals/Ocelot.Discovery.Eureka/ "Ocelot.Discovery.Eureka repository") | [![Ocelot.Discovery.Eureka package](https://img.shields.io/nuget/v/Ocelot.Discovery.Eureka?logo=nuget&label=Ocelot.Discovery.Eureka)](https://www.nuget.org/packages/Ocelot.Discovery.Eureka/ "Ocelot.Discovery.Eureka package") | [![Ocelot.Discovery.Eureka Beta](https://img.shields.io/nuget/vpre/Ocelot.Discovery.Eureka?logo=nuget&label=Ocelot.Discovery.Eureka)](https://www.nuget.org/packages/Ocelot.Discovery.Eureka/ "Ocelot.Discovery.Eureka beta package") | [![Ocelot.Discovery.Eureka Release Date](https://img.shields.io/github/release-date/ThreeMammals/Ocelot.Discovery.Eureka?label=Ocelot.Discovery.Eureka)](https://github.com/ThreeMammals/Ocelot.Discovery.Eureka/releases) |
| [![Ocelot.Discovery.KubeClient repository](https://img.shields.io/github/v/release/ThreeMammals/Ocelot.Discovery.KubeClient?logo=github&label=Ocelot.Discovery.KubeClient&include_prereleases)](https://github.com/ThreeMammals/Ocelot.Discovery.KubeClient/ "Ocelot.Discovery.KubeClient repository") | [![Ocelot.Discovery.KubeClient package](https://img.shields.io/nuget/v/Ocelot.Discovery.KubeClient?logo=nuget&label=Ocelot.Discovery.KubeClient)](https://www.nuget.org/packages/Ocelot.Discovery.KubeClient/ "Ocelot.Discovery.KubeClient package") | [![Ocelot.Discovery.KubeClient Beta](https://img.shields.io/nuget/vpre/Ocelot.Discovery.KubeClient?logo=nuget&label=Ocelot.Discovery.KubeClient)](https://www.nuget.org/packages/Ocelot.Discovery.KubeClient/ "Ocelot.Discovery.KubeClient beta package") | [![Ocelot.Discovery.KubeClient Release Date](https://img.shields.io/github/release-date/ThreeMammals/Ocelot.Discovery.KubeClient?label=Ocelot.Discovery.KubeClient)](https://github.com/ThreeMammals/Ocelot.Discovery.KubeClient/releases) |
| [![Ocelot.QualityOfService.Polly repository](https://img.shields.io/github/v/release/ThreeMammals/Ocelot.QualityOfService.Polly?logo=github&label=Ocelot.QualityOfService.Polly&include_prereleases)](https://github.com/ThreeMammals/Ocelot.QualityOfService.Polly/ "Ocelot.QualityOfService.Polly repository") | [![Ocelot.QualityOfService.Polly package](https://img.shields.io/nuget/v/Ocelot.QualityOfService.Polly?logo=nuget&label=Ocelot.QualityOfService.Polly)](https://www.nuget.org/packages/Ocelot.QualityOfService.Polly/ "Ocelot.QualityOfService.Polly package") | [![Ocelot.QualityOfService.Polly Beta](https://img.shields.io/nuget/vpre/Ocelot.QualityOfService.Polly?logo=nuget&label=Ocelot.QualityOfService.Polly)](https://www.nuget.org/packages/Ocelot.QualityOfService.Polly/ "Ocelot.QualityOfService.Polly beta package") | [![Ocelot.QualityOfService.Polly Release Date](https://img.shields.io/github/release-date/ThreeMammals/Ocelot.QualityOfService.Polly?label=Ocelot.QualityOfService.Polly)](https://github.com/ThreeMammals/Ocelot.QualityOfService.Polly/releases) |
| [![Ocelot.Testing repository](https://img.shields.io/github/v/release/ThreeMammals/Ocelot.Testing?logo=github&label=Ocelot.Testing&include_prereleases)](https://github.com/ThreeMammals/Ocelot.Testing/ "Ocelot.Testing repository") | [![Ocelot.Testing package](https://img.shields.io/nuget/v/Ocelot.Testing?logo=nuget&label=Ocelot.Testing)](https://www.nuget.org/packages/Ocelot.Testing/ "Ocelot.Testing package") | [![Ocelot.Testing Beta](https://img.shields.io/nuget/vpre/Ocelot.Testing?logo=nuget&label=Ocelot.Testing)](https://www.nuget.org/packages/Ocelot.Testing/ "Ocelot.Testing beta package") | [![Ocelot.Testing Release Date](https://img.shields.io/github/release-date/ThreeMammals/Ocelot.Testing?label=Ocelot.Testing)](https://github.com/ThreeMammals/Ocelot.Testing/releases) |

## :warning: Deprecated Packages
The Ocelot development team does not support the following deprecated packages after the Ocelot [v25](https://github.com/ThreeMammals/Ocelot/releases/tag/25.0.0) release.

| Project | Release | Release Date | New Project |
|---------|---------|--------------|-------------|
| [Ocelot.Administration](https://github.com/ThreeMammals/Ocelot/tree/23.4.3/src/Ocelot.Administration/ "Ocelot.Administration repository")<sup>1</sup> | [![Ocelot.Administration package](https://img.shields.io/nuget/v/Ocelot.Administration?logo=nuget&label=Ocelot.Administration)](https://www.nuget.org/packages/Ocelot.Administration/ "Ocelot.Administration package") | [Jan 17, 2025](https://github.com/ThreeMammals/Ocelot/releases/tag/23.4.3) | [![Ocelot.Administration.IdentityServer4 repository](https://img.shields.io/github/v/release/ThreeMammals/Ocelot.Administration.IdentityServer4?logo=github&label=Ocelot.Administration.IdentityServer4&include_prereleases)](https://github.com/ThreeMammals/Ocelot.Administration.IdentityServer4/ "Ocelot.Administration.IdentityServer4 repository") |
| [![Ocelot.Administration.IdentityServer4 repository](https://img.shields.io/github/v/release/ThreeMammals/Ocelot.Administration.IdentityServer4?logo=github&label=Ocelot.Administration.IdentityServer4&include_prereleases)](https://github.com/ThreeMammals/Ocelot.Administration.IdentityServer4/ "Ocelot.Administration.IdentityServer4 repository")<sup>2</sup> | [![Ocelot.Administration.IdentityServer4 package](https://img.shields.io/nuget/v/Ocelot.Administration.IdentityServer4?logo=nuget&label=Ocelot.Administration.IdentityServer4)](https://www.nuget.org/packages/Ocelot.Administration.IdentityServer4/ "Ocelot.Administration.IdentityServer4 package") | [![Ocelot.Administration.IdentityServer4 Release Date](https://img.shields.io/github/release-date/ThreeMammals/Ocelot.Administration.IdentityServer4?label=Ocelot.Administration.IdentityServer4)](https://github.com/ThreeMammals/Ocelot.Administration.IdentityServer4/releases) |  |
...
> <sup>1</sup>These packages are deprecated and archived, so contributions are possible in the new repository.
> <sup>2</sup>These packages are deprecated but not archived, so contributions are still possible.
...
## 📊 NuGet Organization Profile

All packages under the ThreeMammals organization are published to NuGet.org:

**Organization Profile**: [ThreeMammals on NuGet.org](https://www.nuget.org/profiles/ThreeMammals)

Browse all packages published by the organization to discover additional tools and utilities for Ocelot development.

---

## 🔗 Quick Navigation

- **[Main Repository](https://github.com/ThreeMammals/Ocelot)**
- **[Organization on GitHub](https://github.com/ThreeMammals)**
- **[Organization on NuGet.org](https://www.nuget.org/profiles/ThreeMammals)**
- **[Documentation](https://ocelot.readthedocs.io/)**
- **[Contributing Guidelines](https://github.com/ThreeMammals/Ocelot/blob/main/CONTRIBUTING.md)**

---

## 📝 Notes

- Badge information updates automatically from GitHub and NuGet.org
- Release dates reflect the latest stable release
- Pre-release versions indicate development/preview versions
- For detailed release notes, visit the [GitHub Releases](https://github.com/ThreeMammals/Ocelot/releases) page
- All extension packages follow the main Ocelot release cycle

---

**Last Updated**: This page contains dynamically updated badges that reflect real-time package information from NuGet.org and GitHub.
