...
For seasoned fans of Ocelot with a Production environment, it is advised to always consult the :ref:`release-notes` in the :doc:`../releasenotes` section before upgrading the app to the latest `23.3`_ version.
