...
release = 'v20.0 "Polish Apple"' # OK displayed
version = '20.0' # version is not displayed in either HTML pages or PDF docs
today = 'October 7, 2023'
